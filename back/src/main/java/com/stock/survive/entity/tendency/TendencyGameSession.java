...
public class TendencyGameSession {
    ...
    @Column(name = "yield_above_threshold", nullable = false)
    private Boolean yieldAboveThreshold;
    
    @Column(name = "tendency_type", length = 30)
    ...
    public void addWeek(TendencyGameWeek week) {
