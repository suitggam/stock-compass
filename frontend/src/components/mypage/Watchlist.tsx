...
type Item = { name: string; code: string; price: number; diff: number; rate: number };
...
const DUMMY: Item[] = [
  ...
  { name: 'LG에너지솔루션', code: '373220', price: 412000, diff: -5000, rate: -1.2 },
  ...
  return (
    <div className="p-5 rounded-2xl bg-white/85 border border-black/5 shadow-[0_8px_30px_rgba(0,0,0,0.12)] relative">
      ...
      <div className="flex justify-between gap-4">
        <div>
          <div className="text-neutral-900 text-base sm:text-lg font-bold">{item.name}</div>
