...
type Season = { title: string; range: string; change: number; rate: number; total: number };
    ...
    <section className="w-full bg-white/80 backdrop-blur-xl rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.16)] p-6 border border-black/5 relative">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="rounded-2xl p-5 text-center bg-amber-400/10 border border-amber-500/20">
          <div className="text-amber-600 text-xl sm:text-2xl font-bold">{DUMMY.length}</div>
        ...
        <div className="rounded-2xl p-5 text-center bg-amber-400/10 border border-amber-500/20">
          <div className="text-amber-600 text-xl sm:text-2xl font-bold">2.63%</div>
          <div className="text-neutral-500 text-xs">총 수익률</div>
        </div>
        <div className="rounded-2xl p-5 text-center bg-amber-400/10 border border-amber-500/20">
          <div className="text-amber-600 text-xl sm:text-2xl font-bold">69등</div>
      ...
      <div className="mt-6 flex items-center justify-center gap-2">
        <button className="w-8 h-8 opacity-50 bg-neutral-300 rounded" aria-label="prev" />
